...
public class DificuldadeEasy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dificuldade_facil);

        //Banco dados
        bancoDados = openOrCreateDatabase("appclassificacao", MODE_PRIVATE, null);

        //tabela classificacao
        bancoDados.execSQL("CREATE TABLE IF NOT EXISTS classificacoes_facil (id INTEGER PRIMARY KEY AUTOINCREMENT, nickname VARCHAR, pontuacao VARCHAR) ");
    ...
    private void calcutale(){
        ...
        if(primeiraCarta == segundaCarta) {
            ...
            pontosJogador = pontosJogador - 20;
            tv_p1.setText("Pontuação: " + pontosJogador);
    ...
    private void verificaFim(){
        ...
        if(iv_11.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(DificuldadeEasy.this);
            alertDialogBuilder
    ...
    private void salvarClassificacao(String nome, String pontos){
        ...
        try{
            bancoDados.execSQL("INSERT INTO classificacoes_facil (nickname, pontuacao) VALUES ('"+nome+"','"+pontos+"')");
            //Toast.makeText(DificuldadeEasy.this, "Classificacao salva com sucesso!", Toast.LENGTH_SHORT).show();
