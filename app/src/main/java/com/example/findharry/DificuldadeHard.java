...
public class DificuldadeHard extends AppCompatActivity {
    ...
    //Array das imagens
    Integer[] cartasArray = {101,102,103,104,105,106,107,108,109,110,201,202,203,204,205,206,207,208,209,210};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dificuldade_hard);

        //Banco dados
        bancoDados = openOrCreateDatabase("appclassificacao", MODE_PRIVATE, null);

        //tabela classificacao
        bancoDados.execSQL("CREATE TABLE IF NOT EXISTS classificacoes_dificil (id INTEGER PRIMARY KEY AUTOINCREMENT, nickname VARCHAR, pontuacao VARCHAR) ");
    ...
    private void doStuff(ImageView iv, int carta){
        ...
        }else if(cartasArray[carta] == 109){
            iv.setImageResource(image109);
        }else if(cartasArray[carta] == 110){
        ...
        }else if(cartasArray[carta] == 209){
            iv.setImageResource(image209);
        }else if(cartasArray[carta] == 210) {
    ...
    private void calcutale(){
        ...
        if(primeiraCarta == segundaCarta) {
            ...
            if (segundoClique == 0) {
                ...
                iv_44.setVisibility(View.INVISIBLE);
            } else if (segundoClique == 16) {
                iv_51.setVisibility(View.INVISIBLE);
            } else if (segundoClique == 17) {
                iv_52.setVisibility(View.INVISIBLE);
            } else if (segundoClique == 18) {
                iv_53.setVisibility(View.INVISIBLE);
            } else if (segundoClique == 19) {
                iv_54.setVisibility(View.INVISIBLE);
            }
            ...
            iv_51.setImageResource(R.drawable.background);
            iv_52.setImageResource(R.drawable.background);
            iv_53.setImageResource(R.drawable.background);
            iv_54.setImageResource(R.drawable.background);

            pontosJogador = pontosJogador - 50;
            tv_p1.setText("Pontuação: " + pontosJogador);
    ...
    private void verificaFim(){
        if(iv_11.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(DificuldadeHard.this);
            alertDialogBuilder
    ...
    private void salvarClassificacao(String nome, String pontos){
        ...
        try{
            bancoDados.execSQL("INSERT INTO classificacoes_dificil (nickname, pontuacao) VALUES ('"+nome+"','"+pontos+"')");
            //Toast.makeText(DificuldadeHard.this, "Classificacao salva com sucesso!", Toast.LENGTH_SHORT).show();
    ...
    private void frontOfCardsResources(){
        ...
        image109  = R.drawable.carta_9;
        image110  = R.drawable.carta_10;
        ...
        image209 = R.drawable.carta_9p;
        image210 = R.drawable.carta_10p;
